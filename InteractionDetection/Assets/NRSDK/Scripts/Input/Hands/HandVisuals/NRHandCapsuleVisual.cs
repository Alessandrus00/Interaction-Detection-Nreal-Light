...
namespace NRKernal
{
    ...
    public class NRHandCapsuleVisual : MonoBehaviour
    {
        ...
        public class CapsuleVisual
        {
            ...
            public void OnUpdate()
            {
                ...
                if (capsuleVisualInfo.shouldRender)
                {
                    ...
                    if(!capsuleVisualInfo.visibility)
                        m_VisualGO.gameObject.GetComponent<Renderer>().enabled = false;
                    else
                        m_VisualGO.gameObject.GetComponent<Renderer>().enabled = true;
                }
                else
                {
        ...
        public static bool showCapsule = true;
        public Material jointMat;
        public float jointRadius = 0.005f;
        public static bool showJoint = true;
